...
/*  Write a function called findHometownByState which returns the first user which has 
a hometown of the state that is passed in*/
function findHometownByState(home){
  return users.filter(function(val){
    return (val.state == home)
  });
}
